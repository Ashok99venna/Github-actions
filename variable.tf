...
variable "customer_service_instance_type" {
  description = "The type of customer_service instance to start"
  type        = string
}
variable "order_service_instance_type" {
  description = "The type of customer_service instance to start"
  type        = string
}
variable "catalog_service_instance_type" {
  description = "The type of customer_service instance to start"
  type        = string
}
variable "range_service_instance_type" {
  description = "The type of customer_service instance to start"
  type        = string
}
variable "config_service_instance_type" {
  description = "The type of customer_service instance to start"
  type        = string
}
variable "cart_service_instance_type" {
  description = "The type of customer_service instance to start"
  type        = string
}
